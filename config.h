...
static Key keys[] = {
	...
	{ 0,                    XF86XK_Display,                 spawn,          {.v = dispcmd } },
	{ 0,                    XF86XK_MonBrightnessUp,         spawn,          {.v = brupcmd } },
	{ 0,                    XF86XK_MonBrightnessDown,       spawn,          {.v = brdowncmd } },
	{ 0,                    XF86XK_Launch1,                 spawn,          {.v = brhalfcmd } },
